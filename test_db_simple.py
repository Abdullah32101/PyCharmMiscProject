...
try:
    ...
    def test_database_connection():
        ...
        try:
            ...
            cursor.execute(
                "SELECT * FROM test_results ORDER BY test_datetime DESC LIMIT 5"
            )
            ...
            print("-" * 80)
            print(
                f"{'ID':<4} {'Test Case':<25} {'Module':<15} {'Status':<10} {'DateTime':<20}"
            )
            print("-" * 80)
            ...
            for result in results:
                ...
                print(
                    f"{result['id']:<4} {result['test_case_name'][:24]:<25} {result['module_name'][:14]:<15} {result['test_status']:<10} {test_datetime:<20}"
                )
