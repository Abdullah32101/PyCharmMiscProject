    ...
    test_configs = [
        {
            ...
            "pytest_args": [
                ...
                "--html",
                f"{reports_dir}/one_time_book_purchase_desktop_{timestamp}.html",
                "--self-contained-html",
                "--metadata",
                "Device",
                "Desktop",
        ...
        },
        {
            ...
            "pytest_args": [
                "tests/test_one_time_book_purchase.py::test_book_page_load_and_click",
                "--html",
                f"{reports_dir}/one_time_book_purchase_ipad_{timestamp}.html",
                "--self-contained-html",
                "--metadata",
                "Device",
                "iPad Pro",
    ...
    for config in test_configs:
        ...
        try:
            ...
            result = {
                ...
                "report_file": config["pytest_args"][
                    config["pytest_args"].index("--html") + 1
                ],
            }
