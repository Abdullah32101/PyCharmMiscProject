        ...
        try:
            ...
            books_data = [
                ...
                (
                    ...
                    2023,
                    59.99,
                    "Modern business management strategies",
                    "Business",
                ),
            ]
...
def main():
    ...
    try:
        ...
        if command == "help":
            ...
            if len(sys.argv) < 3:
                print(
                    "❌ Please specify a table name: python manage_database.py view <table_name>"
                )
                return
            ...
            if len(sys.argv) < 4:
                print(
                    "❌ Please specify table and search term: python manage_database.py search <table> <term>"
                )
                return
